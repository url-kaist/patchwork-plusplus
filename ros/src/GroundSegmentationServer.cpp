...
GroundSegmentationServer::GroundSegmentationServer(const rclcpp::NodeOptions &options)
  ...
  Patchworkpp_ = std::make_unique<patchwork::PatchWorkpp>(patchwork_parameters);
  ...
  nonground_publisher_ = create_publisher<sensor_msgs::msg::PointCloud2>("/patchworkpp/non_ground", qos);
